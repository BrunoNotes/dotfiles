...
M.window = function()
    ...
    nmap("<C-S-K>", "<cmd>resize -2<CR>", "Resize window up")
    nmap("<C-S-J>", "<cmd>resize +2<CR>", "Resize window down")
    nmap("<C-S-H>", "<cmd>vertical resize -2<CR>", "Resize window left")
    nmap("<C-S-L>", "<cmd>vertical resize +2<CR>", "Resize window rigt")
